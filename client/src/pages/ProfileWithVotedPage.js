      ...
      <div className="max-w-4xl mx-auto p-4 md:p-8">
        ...
        <div className="text-center mb-6">
          <button
            ...
            className="px-6 py-3 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
            {isFavoritesVisible ? 'Cài đặt thông tin cá nhân' : 'Bài viết yêu thích'}
          </button>
        </div>
        {/* Page Header */}
        {isFavoritesVisible ? <FavoritesPage className={`bg-inherit`} /> : (<>
