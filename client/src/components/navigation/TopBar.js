...
const TopBar = () => {
  ...
  return (
    <div className={`fixed top-0 right-0 left-64 h-16 z-navbar ${
            ...
            <AnimatePresence>
              {showSearchSuggestions && searchQuery.length > 0 && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -10 }}
                  className={`absolute top-full left-0 right-0 mt-2 z-popover ${
              ...
              <AnimatePresence>
                {showUserMenu && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    exit={{ opacity: 0, y: -10 }}
                    className={`absolute right-0 top-full mt-2 w-64 z-dropdown ${
                      isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'
                    } border rounded-lg shadow-lg`}
                  >
