...
const UserVotedPosts = () => {
  ...
  const getVoteColor = (voteType) => {
    switch (voteType) {
      case 'safe':
        return 'bg-green-50/70 text-green-700 dark:bg-green-900/20 dark:text-green-300';
      case 'unsafe':
        return 'bg-red-50/70 text-red-700 dark:bg-red-900/20 dark:text-red-300';
      case 'suspicious':
        return 'bg-yellow-50/70 text-yellow-700 dark:bg-yellow-900/20 dark:text-yellow-300';
      default:
